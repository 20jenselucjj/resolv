...
export default function KnowledgeBasePage() {
  ...
  // Real-time updates: refresh article list when KB changes
  useEffect(() => {
    ...
    socket.on('knowledge:created', handleKbChange);
    socket.on('knowledge:updated', handleKbChange);
    socket.on('knowledge:deleted', handleKbChange);

    return () => {
      socket.off('knowledge:created', handleKbChange);
      socket.off('knowledge:updated', handleKbChange);
      socket.off('knowledge:deleted', handleKbChange);
    };
  }, [fetchData]);
