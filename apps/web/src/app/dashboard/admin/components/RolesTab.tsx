...
const ITSM_PERMS_ADMIN = [
  { key: 'view_problems', label: 'View Problems', description: 'View problem records', enabled: true },
  { key: 'manage_problems', label: 'Manage Problems', description: 'Create and edit problem records', enabled: true },
  { key: 'delete_problems', label: 'Delete Problems', description: 'Permanently delete problem records', enabled: true },
  { key: 'view_changes', label: 'View Changes', description: 'View change requests', enabled: true },
  { key: 'create_changes', label: 'Create Changes', description: 'Create new change requests', enabled: true },
  { key: 'manage_changes', label: 'Manage Changes', description: 'Edit, start, complete, rollback changes', enabled: true },
  { key: 'approve_changes', label: 'Approve Changes', description: 'Approve or reject change requests', enabled: true },
  { key: 'delete_changes', label: 'Delete Changes', description: 'Permanently delete change requests', enabled: true },
  { key: 'manage_knowledge', label: 'Manage Knowledge Base', description: 'Create and edit knowledge articles', enabled: true },
  { key: 'delete_knowledge', label: 'Delete Knowledge', description: 'Permanently delete knowledge articles', enabled: true },
  { key: 'view_knowledge_drafts', label: 'View KB Drafts', description: 'View unpublished knowledge drafts', enabled: true },
  { key: 'create_approvals', label: 'Create Approvals', description: 'Create approval workflows', enabled: true },
  { key: 'vote_approvals', label: 'Vote on Approvals', description: 'Cast votes on approval requests', enabled: true },
  { key: 'view_licenses', label: 'View Licenses', description: 'View software license inventory', enabled: true },
  { key: 'manage_licenses', label: 'Manage Licenses', description: 'Create and edit software licenses', enabled: true },
  { key: 'delete_licenses', label: 'Delete Licenses', description: 'Delete software license records', enabled: true },
  { key: 'manage_catalog', label: 'Manage Service Catalog', description: 'Create and edit service catalog items', enabled: true },
  { key: 'delete_catalog', label: 'Delete Catalog Items', description: 'Delete service catalog items', enabled: true },
  { key: 'manage_custom_fields', label: 'Manage Custom Fields', description: 'Create and edit custom ticket fields', enabled: true },
  { key: 'manage_classification', label: 'Manage Classification', description: 'Configure auto-classification rules', enabled: true },
];

const ITSM_PERMS_MANAGER = [
  { key: 'view_problems', label: 'View Problems', description: 'View problem records', enabled: true },
  { key: 'manage_problems', label: 'Manage Problems', description: 'Create and edit problem records', enabled: true },
  { key: 'delete_problems', label: 'Delete Problems', description: 'Permanently delete problem records', enabled: false },
  { key: 'view_changes', label: 'View Changes', description: 'View change requests', enabled: true },
  { key: 'create_changes', label: 'Create Changes', description: 'Create new change requests', enabled: true },
  { key: 'manage_changes', label: 'Manage Changes', description: 'Edit, start, complete, rollback changes', enabled: true },
  { key: 'approve_changes', label: 'Approve Changes', description: 'Approve or reject change requests', enabled: true },
  { key: 'delete_changes', label: 'Delete Changes', description: 'Permanently delete change requests', enabled: false },
  { key: 'manage_knowledge', label: 'Manage Knowledge Base', description: 'Create and edit knowledge articles', enabled: true },
  { key: 'delete_knowledge', label: 'Delete Knowledge', description: 'Permanently delete knowledge articles', enabled: false },
  { key: 'view_knowledge_drafts', label: 'View KB Drafts', description: 'View unpublished knowledge drafts', enabled: true },
  { key: 'create_approvals', label: 'Create Approvals', description: 'Create approval workflows', enabled: true },
  { key: 'vote_approvals', label: 'Vote on Approvals', description: 'Cast votes on approval requests', enabled: true },
  { key: 'view_licenses', label: 'View Licenses', description: 'View software license inventory', enabled: true },
  { key: 'manage_licenses', label: 'Manage Licenses', description: 'Create and edit software licenses', enabled: true },
  { key: 'delete_licenses', label: 'Delete Licenses', description: 'Delete software license records', enabled: false },
  { key: 'manage_catalog', label: 'Manage Service Catalog', description: 'Create and edit service catalog items', enabled: true },
  { key: 'delete_catalog', label: 'Delete Catalog Items', description: 'Delete service catalog items', enabled: false },
  { key: 'manage_custom_fields', label: 'Manage Custom Fields', description: 'Create and edit custom ticket fields', enabled: true },
  { key: 'manage_classification', label: 'Manage Classification', description: 'Configure auto-classification rules', enabled: true },
];

const ITSM_PERMS_AGENT = [
  { key: 'view_problems', label: 'View Problems', description: 'View problem records', enabled: true },
  { key: 'manage_problems', label: 'Manage Problems', description: 'Create and edit problem records', enabled: true },
  { key: 'delete_problems', label: 'Delete Problems', description: 'Permanently delete problem records', enabled: false },
  { key: 'view_changes', label: 'View Changes', description: 'View change requests', enabled: true },
  { key: 'create_changes', label: 'Create Changes', description: 'Create new change requests', enabled: false },
  { key: 'manage_changes', label: 'Manage Changes', description: 'Edit, start, complete, rollback changes', enabled: false },
  { key: 'approve_changes', label: 'Approve Changes', description: 'Approve or reject change requests', enabled: false },
  { key: 'delete_changes', label: 'Delete Changes', description: 'Permanently delete change requests', enabled: false },
  { key: 'manage_knowledge', label: 'Manage Knowledge Base', description: 'Create and edit knowledge articles', enabled: true },
  { key: 'delete_knowledge', label: 'Delete Knowledge', description: 'Permanently delete knowledge articles', enabled: false },
  { key: 'view_knowledge_drafts', label: 'View KB Drafts', description: 'View unpublished knowledge drafts', enabled: true },
  { key: 'create_approvals', label: 'Create Approvals', description: 'Create approval workflows', enabled: false },
  { key: 'vote_approvals', label: 'Vote on Approvals', description: 'Cast votes on approval requests', enabled: false },
  { key: 'view_licenses', label: 'View Licenses', description: 'View software license inventory', enabled: true },
  { key: 'manage_licenses', label: 'Manage Licenses', description: 'Create and edit software licenses', enabled: false },
  { key: 'delete_licenses', label: 'Delete Licenses', description: 'Delete software license records', enabled: false },
  { key: 'manage_catalog', label: 'Manage Service Catalog', description: 'Create and edit service catalog items', enabled: false },
  { key: 'delete_catalog', label: 'Delete Catalog Items', description: 'Delete service catalog items', enabled: false },
  { key: 'manage_custom_fields', label: 'Manage Custom Fields', description: 'Create and edit custom ticket fields', enabled: false },
  { key: 'manage_classification', label: 'Manage Classification', description: 'Configure auto-classification rules', enabled: false },
];

const ITSM_PERMS_USER = [
  { key: 'view_problems', label: 'View Problems', description: 'View problem records', enabled: false },
  { key: 'manage_problems', label: 'Manage Problems', description: 'Create and edit problem records', enabled: false },
  { key: 'delete_problems', label: 'Delete Problems', description: 'Permanently delete problem records', enabled: false },
  { key: 'view_changes', label: 'View Changes', description: 'View change requests', enabled: false },
  { key: 'create_changes', label: 'Create Changes', description: 'Create new change requests', enabled: false },
  { key: 'manage_changes', label: 'Manage Changes', description: 'Edit, start, complete, rollback changes', enabled: false },
  { key: 'approve_changes', label: 'Approve Changes', description: 'Approve or reject change requests', enabled: false },
  { key: 'delete_changes', label: 'Delete Changes', description: 'Permanently delete change requests', enabled: false },
  { key: 'manage_knowledge', label: 'Manage Knowledge Base', description: 'Create and edit knowledge articles', enabled: false },
  { key: 'delete_knowledge', label: 'Delete Knowledge', description: 'Permanently delete knowledge articles', enabled: false },
  { key: 'view_knowledge_drafts', label: 'View KB Drafts', description: 'View unpublished knowledge drafts', enabled: false },
  { key: 'create_approvals', label: 'Create Approvals', description: 'Create approval workflows', enabled: false },
  { key: 'vote_approvals', label: 'Vote on Approvals', description: 'Cast votes on approval requests', enabled: false },
  { key: 'view_licenses', label: 'View Licenses', description: 'View software license inventory', enabled: false },
  { key: 'manage_licenses', label: 'Manage Licenses', description: 'Create and edit software licenses', enabled: false },
  { key: 'delete_licenses', label: 'Delete Licenses', description: 'Delete software license records', enabled: false },
  { key: 'manage_catalog', label: 'Manage Service Catalog', description: 'Create and edit service catalog items', enabled: false },
  { key: 'delete_catalog', label: 'Delete Catalog Items', description: 'Delete service catalog items', enabled: false },
