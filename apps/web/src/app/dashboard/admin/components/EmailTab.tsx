...
import { Server, Mail, FileText, Reply, Inbox, Settings } from 'lucide-react';
...
type EmailSubTab = 'accounts' | 'outbound' | 'inbound' | 'templates' | 'auto-reply' | 'email-log';
...
const SUB_TABS: SubTabConfig[] = [
  { id: 'accounts', label: 'Accounts', icon: <Settings size={14} /> },
...
export function EmailTab({ showAlert, setConfirmModal }: {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
      ...
      {/* Content */}
      {activeSubTab === 'accounts' && <EmailAccountsTab showAlert={showAlert} />}
