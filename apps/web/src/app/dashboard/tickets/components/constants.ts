...
export const STATUS_OPTIONS = ['all', 'open', 'in_progress', 'waiting', 'resolved', 'closed'];
...
export const statusConfig: Record<string, { label: string; badgeClass: string }> = {
  ...
  resolved:    { label: 'Resolved',    badgeClass: 'badge badge-resolved' },
  closed:      { label: 'Closed',      badgeClass: 'badge badge-closed' },
};
...
export const STATUS_ORDER: Record<string, number> = { open: 0, in_progress: 1, waiting: 2, resolved: 3, closed: 4 };
...
export const ALL_COLUMNS = [
  ...
  { id: 'asset', label: 'Asset', width: 120, minWidth: 80, sortable: false },
