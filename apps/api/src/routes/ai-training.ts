...
export async function aiTrainingRoutes(app: FastifyInstance) {
  ...
  // ── GET /ai/rag/config ──────────────────────────────────────────────────────
  app.get('/ai/rag/config', { preHandler: [app.authenticate, app.requirePermission('manage_ai_config')] }, async (req, reply) => {
  ...
  // ── PUT /ai/rag/config ──────────────────────────────────────────────────────
  app.put('/ai/rag/config', { preHandler: [app.authenticate, app.requirePermission('manage_ai_config')] }, async (req, reply) => {
    ...
    try {
      ...
      app.log.error({ err: logErr }, 'Failed to write audit log');
    }
    return reply.send({ data: rows[0] })
  })

  // ── GET /ai/knowledge/sources ───────────────────────────────────────────────
  app.get('/ai/knowledge/sources', { preHandler: [app.authenticate, app.requirePermission('manage_ai_config')] }, async (req, reply) => {
    const { rows } = await pool.query(
  ...
  app.post('/ai/knowledge/sources', { preHandler: [app.authenticate, app.requirePermission('manage_ai_config')] }, async (req, reply) => {
    ...
    app.io.emit('knowledge:source:created', { source })
  ...
  app.post('/ai/knowledge/sources/upload', { preHandler: [app.authenticate, app.requirePermission('manage_ai_config')] }, async (req, reply) => {
    const user = (req as any).user
  ...
  app.get('/ai/knowledge/sources/:id', { preHandler: [app.authenticate, app.requirePermission('manage_ai_config')] }, async (req, reply) => {
  ...
  app.patch('/ai/knowledge/sources/:id', { preHandler: [app.authenticate, app.requirePermission('manage_ai_config')] }, async (req, reply) => {
    const { id } = req.params as any
    const body = req.body as any
    const { rows } = await pool.query(
    ...
    app.io.emit('knowledge:source:updated', { source: updated })
    return reply.send({ data: updated })
  })

  // ── DELETE /ai/knowledge/sources/:id ───────────────────────────────────────
  app.delete('/ai/knowledge/sources/:id', { preHandler: [app.authenticate, app.requirePermission('manage_ai_config')] }, async (req, reply) => {
    const user = (req as any).user
    const { id } = req.params as any
    ...
    app.io.emit('knowledge:source:deleted', { id })
    return reply.send({ data: { success: true } })
  })

  // ── POST /ai/knowledge/sources/:id/reprocess ───────────────────────────────
  app.post('/ai/knowledge/sources/:id/reprocess', { preHandler: [app.authenticate, app.requirePermission('manage_ai_config')] }, async (req, reply) => {
    const { id } = req.params as any
  ...
  app.get('/ai/knowledge/sources/:id/chunks', { preHandler: [app.authenticate, app.requirePermission('manage_ai_config')] }, async (req, reply) => {
    const { id } = req.params as any
    const { rows } = await pool.query(
  ...
  // ── GET /ai/knowledge/qa ────────────────────────────────────────────────────
  app.get('/ai/knowledge/qa', { preHandler: [app.authenticate, app.requirePermission('manage_ai_config')] }, async (req, reply) => {
    const { rows } = await pool.query(
  ...
  app.post('/ai/knowledge/qa', { preHandler: [app.authenticate, app.requirePermission('manage_ai_config')] }, async (req, reply) => {
    const user = (req as any).user
    const body = req.body as any
  ...
  app.patch('/ai/knowledge/qa/:id', { preHandler: [app.authenticate, app.requirePermission('manage_ai_config')] }, async (req, reply) => {
    const { id } = req.params as any
    const body = req.body as any
  ...
  app.delete('/ai/knowledge/qa/:id', { preHandler: [app.authenticate, app.requirePermission('manage_ai_config')] }, async (req, reply) => {
    const { id } = req.params as any
  ...
  // ── POST /ai/rag/test ───────────────────────────────────────────────────────
  app.post('/ai/rag/test', { preHandler: [app.authenticate, app.requirePermission('manage_ai_config')] }, async (req, reply) => {
    const body = req.body as any
    const { query } = body
  ...
  app.get('/ai/rag/analytics', { preHandler: [app.authenticate, app.requirePermission('manage_ai_config')] }, async (req, reply) => {
    const [
      { rows: totalQueries },
      { rows: recentQueries },
      { rows: sourceStats },
  ...
  app.post('/ai/knowledge/kb-sync', { preHandler: [app.authenticate, app.requirePermission('manage_ai_config')] }, async (req, reply) => {
    const user = (req as any).user
  ...
  app.post('/ai/knowledge/ticket-sync', { preHandler: [app.authenticate, app.requirePermission('manage_ai_config')] }, async (req, reply) => {
    const user = (req as any).user
    const body = req.body as any
  ...
  app.patch('/ai/rag/queries/:id/flag', { preHandler: [app.authenticate, app.requirePermission('manage_ai_config')] }, async (req, reply) => {
    const { id } = req.params as any
    const body = req.body as any
    await pool.query(
