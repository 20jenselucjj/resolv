...
import type { AiConfig, RagConfig } from './ai-training.types'
...
export async function getEmbedding(text: string, cfg: AiConfig): Promise<number[] | null> {
  try {
...
export async function processSource(sourceId: string, rawContent: string, cfg: AiConfig | null, ragCfg: RagConfig) {
