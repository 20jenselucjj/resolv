...
import { saveBusinessHoursConfig, updateDaySchedule, addHoliday, getHolidays } from '../services/business-hours';
...
export default async function notificationConfigRoutes(fastify: FastifyInstance) {
  ...
  fastify.get('/admin/notification-schedule/config', { preHandler: [fastify.requirePermission('manage_notification_settings')] }, async (_request, reply) => {
  ...
  fastify.post('/admin/notification-schedule/config', { preHandler: [fastify.requirePermission('manage_notification_settings')] }, async (request, reply) => {
    const body = z.object({
  ...
  fastify.get('/admin/satisfaction/config', { preHandler: [fastify.requirePermission('manage_notification_settings')] }, async (_request, reply) => {
  ...
  fastify.post('/admin/satisfaction/config', { preHandler: [fastify.requirePermission('manage_notification_settings')] }, async (request, reply) => {
    const body = z.object({
      enabled: z.boolean().optional(),
  ...
  fastify.get('/admin/escalation/config', { preHandler: [fastify.requirePermission('manage_notification_settings')] }, async (_request, reply) => {
  ...
  fastify.post('/admin/escalation/config', { preHandler: [fastify.requirePermission('manage_notification_settings')] }, async (request, reply) => {
    const body = z.object({
      enabled: z.boolean().optional(),
      unassigned: z.object({
        enabled: z.boolean().optional(),
  ...
  fastify.get('/admin/throttling/config', { preHandler: [fastify.requirePermission('manage_notification_settings')] }, async (_request, reply) => {
  ...
  fastify.post('/admin/throttling/config', { preHandler: [fastify.requirePermission('manage_notification_settings')] }, async (request, reply) => {
    const body = z.object({
      enabled: z.boolean().optional(),
  ...
  fastify.get('/admin/business-hours/config', { preHandler: [fastify.requirePermission('manage_notification_settings')] }, async (_request, reply) => {
  ...
  fastify.post('/admin/business-hours/config', { preHandler: [fastify.requirePermission('manage_notification_settings')] }, async (request, reply) => {
    const body = z.object({
      enabled: z.boolean().optional(),
  ...
  fastify.put('/admin/business-hours/schedule/:dayOfWeek', { preHandler: [fastify.requirePermission('manage_notification_settings')] }, async (request, reply) => {
  ...
  fastify.post('/admin/business-hours/holidays', { preHandler: [fastify.requirePermission('manage_notification_settings')] }, async (request, reply) => {
    const body = z.object({
      name: z.string().min(1),
  ...
  fastify.delete('/admin/business-hours/holidays/:id', { preHandler: [fastify.requirePermission('manage_notification_settings')] }, async (request, reply) => {
    const { id } = request.params as { id: string };

    const result = await pool.query('DELETE FROM business_holidays WHERE id = $1 RETURNING id', [id]);
  ...
  fastify.post('/admin/notification-schedule/force-run', { preHandler: [fastify.requirePermission('manage_notification_settings')] }, async (_request, reply) => {
  ...
  fastify.get('/admin/notification-log', { preHandler: [fastify.requirePermission('manage_notification_settings')] }, async (request, reply) => {
